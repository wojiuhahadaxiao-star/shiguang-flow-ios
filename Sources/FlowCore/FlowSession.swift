...
public final class FlowSession {
    ...
    public var hasPrevious: Bool { if case .random = mode { return false }; return page > 0 }
    public var hasNext: Bool { if case .random = mode { return false }; return (page + 1) * pageSize < allModeIDs.count }
    ...
    public func stage(_ id: String) {
        ...
        history.append(UndoEntry(id: id, mode: mode, page: page, randomIDs: randomIDs))
